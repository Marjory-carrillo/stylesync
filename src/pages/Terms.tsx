                ...
                <div className="prose prose-invert max-w-none space-y-10 text-slate-300 leading-relaxed">
                    ...
                    <section>
                        ...
                        <div className="mt-4 space-y-3">
                            ...
                            <div className="bg-white/[0.02] border border-teal-500/20 rounded-2xl p-4">
                                <p className="font-bold text-white">Plan Esencial — $299 MXN/mes</p>
                                <p className="text-slate-400 text-sm mt-1">1 estilista/profesional independiente, citas ilimitadas, 1 sucursal.</p>
                            </div>
                            <div className="bg-white/[0.02] border border-violet-500/20 rounded-2xl p-4">
                                <p className="font-bold text-white">Plan Pro — $599 MXN/mes</p>
                                <p className="text-slate-400 text-sm mt-1">2 estilistas incluidos, citas ilimitadas, 1 sucursal. Estilistas adicionales a $199 MXN/mes c/u.</p>
                            </div>
                            <div className="bg-white/[0.02] border border-amber-500/20 rounded-2xl p-4">
                                <p className="font-bold text-white">Plan Business — $1,049 MXN/mes</p>
                                <p className="text-slate-400 text-sm mt-1">2 sucursales incluidas, citas ilimitadas. Sucursales adicionales a $549 MXN/mes. Estilistas adicionales a $199 MXN/mes c/u.</p>
                            </div>
                        </div>
